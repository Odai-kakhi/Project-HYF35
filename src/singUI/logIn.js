            ...
            return (
                <div className='container-1'>
                    <div className='container'>
                        <div className="login">
                            <h1>Login</h1>
                            <input type="email" name="email" placeholder="E-mail" required="required" id= 'email' onChange={(event) => {
                            ...
                            />
                            <input type="password" name="password" placeholder="Password" required="required" id= 'password' onChange={(event) => userPassword = event.target.value} onClick={() => {
                                store.setState({
                                    programScreen: 'record',
                                    myPrograms: false,
                                })
                ...
                <div className='container-1'>
                    <div className='container'>
                        <div className="singup">
                            <h1>Sign up</h1>
                            <input type="text" name="firstname" placeholder="First name" required="required" id= 'firstname' onChange={(event) => { userFirstName = event.target.value }} />
                            <input type="text" name="lastname" placeholder="Last name" required="required" id= 'lastname' onChange={(event) => userLastName = event.target.value} />
                            <input type="text" name="email" placeholder="E-mail" required="required" id= 'email' onChange={(event) => singUpEmail = event.target.value} />
                            <input type="password" name="password" placeholder="Password" required="required" id= 'password' onChange={(event) => singUpPassword = event.target.value} />
                            <input type="password" name="confirmPassword" placeholder="Confirm Password" id= 'cpassword' required="required" onChange={(event) => singUpConfirmPassword = event.target.value} />
